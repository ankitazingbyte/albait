...
class ContactUsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_u" do
    assert_difference('ContactU.count') do
      post contact_us_url, params: { contact_u: { address: @contact_u.address, contact_num: @contact_u.contact_num, email: @contact_u.email } }
    end
  ...
  test "should update contact_u" do
    patch contact_u_url(@contact_u), params: { contact_u: { address: @contact_u.address, contact_num: @contact_u.contact_num, email: @contact_u.email } }
