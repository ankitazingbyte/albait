...
class AboutUsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about_u" do
    assert_difference('AboutU.count') do
      post about_us_url, params: { about_u: { description: @about_u.description, image: @about_u.image } }
    end
  ...
  test "should update about_u" do
    patch about_u_url(@about_u), params: { about_u: { description: @about_u.description, image: @about_u.image } }
